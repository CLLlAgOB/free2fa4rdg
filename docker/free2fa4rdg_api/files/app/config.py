...
class Config:
    ...
    AUTO_REG_ENABLED = os.environ.get("FREE2FA_AUTO_REG_ENABLED", "false").lower() == "true"
    # Without confirmation to log in to the server
    # Allow access to the server for users with telegram ID 0
    BYPASS_ENABLED = os.environ.get("FREE2FA_BYPASS_ENABLED", "false").lower() == "true"
    ...
    ALLOW_API_FAILURE_PASS = os.environ.get("ALLOW_API_FAILURE_PASS", "false").lower() == "true"
