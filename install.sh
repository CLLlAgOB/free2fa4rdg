...
ADDITIONAL_DNS_NAME_FOR_ADMIN_HTML=${15:-free2fa4rdg}
REQUIRE_MESSAGE_AUTHENTICATOR=${16:-true}
...
curl -L "https://raw.githubusercontent.com/Oncek/free2fa4rdg/main/docker-compose/docker-compose.yml" -o docker-compose.yml
